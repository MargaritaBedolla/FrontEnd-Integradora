...
<head>
    ...
    <script type="text/javascript" src="../../../../scripts/historial.js?v1.0.0"></script>
...
<body>
    ...
    <div class="stack">
        <div class="stack-1">
            <div class="container">
                <table id="tabla-datos" class="container">
            ...
            <div class="btns">
                <h3>Filtrar por:</h3>
                <a class="e" href="../historial-entrada/historial-entrada.component.html">Entradas</a>
                <a class="s" href="../historial-salida/historial-salida.component.html">Salidas</a>
            </div>
        </div>
    </div>
