...
<body>
    ...
    <div class="boxf">
        <form class="box" action="index.html" method="post">
            ...
            <p>Elegir tipo de usuario</p>
            <select name="usertype" id="usertype">
                <option value="usuario">Usuario</option>
                <option value="administrador">Administrador</option>
            </select>
            <a href="http://localhost/Final/" id='submit' type="submit" name="" value="">Registrate</a>
            <li><a href="http://localhost/Final/">Si ya tienes cuenta inicia sesion</a></li>
        </form>
    </div>
